...
/** source: /var/www/html/wp-content/plugins/packeta/template/order/customs-declaration-item.latte */
final class Templated39ab4f56e extends \Packetery\Latte\Runtime\Template
{
	...
	public function main(): array
	{
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["customs_code"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 11 */;
		echo '>
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["value"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 19 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["product_name_en"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 27 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["product_name"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 35 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["units_count"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 43 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["country_of_origin"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 51 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["weight"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 59 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["is_food_or_book"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 68 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
		...
		echo '"';
		$ʟ_input = $_input = end($this->global->formsStack)["is_voc"];
		echo $ʟ_input->getControlPart()->addAttributes(['data-lfv-message-id' => null])->attributes() /* line 76 */;
		echo '>
					<p class="packetery-input-validation-message help-block text-danger"
						id="';
