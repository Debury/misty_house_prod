...
/** source: /var/www/html/wp-content/plugins/packeta/template/order/modal-template.latte */
final class Template6f29f9685a extends \Packetery\Latte\Runtime\Template
{
	...
	<div class="wc-backbone-modal" data-packetery-modal>
		...
		echo '" class="{{ data.order.manualWeightIconExtraClass }}dashicons dashicons-lock"></span>
									...
									<td>
										';
		echo end($this->global->formsStack)["packeteryWeight"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryWeight }}']) /* line 28 */;
		echo '
										';
		...
		echo '</td>
									<td>';
		echo end($this->global->formsStack)["packeteryLength"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryLength }}']) /* line 35 */;
		echo '</td>
								</tr>
								<tr>
									<td>';
		...
		echo '</td>
									<td>';
		echo end($this->global->formsStack)["packeteryWidth"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryWidth }}']) /* line 39 */;
		echo '</td>
								</tr>
								<tr>
									<td>';
		...
		echo '</td>
									<td>';
		echo end($this->global->formsStack)["packeteryHeight"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryHeight }}']) /* line 43 */;
		echo '</td>
								</tr>
								<# } #>
		...
		echo '</td>
									<td>
										<input type="checkbox" name="packeteryAdultContent"
		...
		echo '" class="{{ data.order.manualCodIconExtraClass }}dashicons dashicons-lock"></span>
									...
									<td>
										';
		echo end($this->global->formsStack)["packeteryCOD"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryCOD }}']) /* line 65 */;
		echo '
										';
		...
		echo '" class="{{ data.order.manualValueIconExtraClass }}dashicons dashicons-lock"></span>
									...
									<td>
										';
		echo end($this->global->formsStack)["packeteryValue"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryValue }}']) /* line 76 */;
		echo '
										';
		...
		echo '</td>
									<td>';
		echo end($this->global->formsStack)["packeteryDeliverOn"]->getControl()->addAttributes(['value' =>'{{ data.order.packeteryDeliverOn }}']) /* line 83 */;
		echo '</td>
								</tr>
								<# } #>
								</tbody>
